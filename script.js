...
function randomGenerator () {
    ...
    var direction = ["ascendiendo", "descendiendo"];
    ...
    document.getElementById("answer").innerHTML = "Toca " + numberOfNotes + "  notas, desde donde terminaste de " + notes + scaleArpeggio + " " + direction + ".";
